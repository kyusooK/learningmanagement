...
pluralCaseList.push( {plural: "lectures/lectures", pascal: "LectureLecture"} )

pluralCaseList.push( {plural: "users/users", pascal: "UserUser"} )

pluralCaseList.push( {plural: "studies/studies", pascal: "StudyStudy"} )

pluralCaseList.push( {plural: "lecturesupports/assignments", pascal: "LecturesupportAssignment"} )
pluralCaseList.push( {plural: "lecturesupports/lectureSuggestions", pascal: "LecturesupportLectureSuggestion"} )
