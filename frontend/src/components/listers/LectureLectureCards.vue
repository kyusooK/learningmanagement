    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">강의</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <LectureLecture :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row class="ma-0 pa-0">
            <v-col class="pa-4" cols="12" sm="6" md="3" v-for="(value, index) in values" :key="index">
                <LectureLecture :offline="offline"
...
<script>
    ...
    import LectureLecture from './../LectureLecture.vue';
