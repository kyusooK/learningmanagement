<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Boolean label="IsTutor" v-model="item.isTutor" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="TutorApprove" v-model="item.tutorApprove" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Interest" v-model="item.interest" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="SuggestionLecture" v-model="item.suggestionLecture" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
