        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">학습정보</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <StudyStudy :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            me.values = temp.data._embedded.studies;
